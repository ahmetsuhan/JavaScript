        ...
        servisKayitlari:[
            {
                ...
                detay:[ 
                    ...
                    {id:"bmw116d_123_1_3",aciklama:"fren fidroliği",ucret:300}
                ]
            },
            {
                id:"bmw116d_123_2",
                ...
                detay:[
                    ...
                    {id:"bmw116d_123_2_3",aciklama:"fren fidroliği",ucret:300},
        ...
        servisKayitlari:[
            {
                ...
                ucret:900,
                detay:[ 
                    {id:"bmw118i_1234_1_1",aciklama:"yağ değişimi",ucret:300},
                    {id:"bmw118i_1234_1_2",aciklama:"filtre değişimi",ucret:300},
                    {id:"bmw118i_1234_1_3",aciklama:"fren fidroliği",ucret:300}
                ]
            },
            {
                id:"bmw116d_1234_2",
                ...
                ucret:1800,
                detay:[
                    {id:"bmw118i_1234_2_1",aciklama:"yağ değişimi",ucret:350},
                    {id:"bmw118i_1234_2_2",aciklama:"filtre değişimi",ucret:350},
                    {id:"bmw118i_1234_2_3",aciklama:"fren fidroliği",ucret:300},
                    {id:"bmw118i_1234_2_4",aciklama:"balata değişimi",ucret:800}
                ]
            },
        ]
    },
        ...
        servisKayitlari:[
            {
                ...
                detay:[ 
                    ...
                    {id:"bmw320d_123_1_3",aciklama:"fren fidroliği",ucret:300}
                ]
            },
            {
                id:"bmw320d_123_2",
                ...
                detay:[
                    ...
                    {id:"bmw320d_123_2_3",aciklama:"fren fidroliği",ucret:300},
                    {id:"bmw320d_123_2_4",aciklama:"balata değişimi",ucret:800}
                ]
            },
        ]
    }
...
console.log(aracBilgileri[0].servisKayitlari[0].id);
